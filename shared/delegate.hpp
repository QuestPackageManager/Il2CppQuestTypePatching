...
namespace custom_types {
    ...
    template <typename T>
    using make_boxed_t = std::conditional_t<::i2c::type_check::value_type<T>, T*, T>;

    template <typename T>
    auto unbox_arg(T arg) {
        if constexpr (std::is_pointer_v<T> && ::i2c::type_check::value_type<std::remove_pointer_t<T>>) {
            return *arg;
        } else {
            return arg;
        }
    ...
    struct DelegateWrapperStatic : Il2CppObject {
       ...
       public:
        struct ___TypeRegistration : ::custom_types::TypeRegistration {
            ...
            char*& static_fields() override { return st_fields; }
            size_t static_fields_size() const override { return 0; }
            char const* name() const override {
                if constexpr (!std::is_same_v<void, RI>) {
                    static std::string nm{fmt::format(
                        "DelegateWrapper({} ret, {} args, {} sz) ({})",
                        sizeof(RI),
                        sizeof...(TArgsI),
                        sizeof(___TargetType),
                        custom_types::get_delegate_count()
                    )};
                    return nm.c_str();
                } else {
                    static std::string nm{fmt::format(
                        "DelegateWrapper(void ret, {} args, {} sz) ({})", sizeof...(TArgsI), sizeof(___TargetType), custom_types::get_delegate_count()
                    )};
                    return nm.c_str();
                }
            }
            constexpr char const* namespaze() const override { return "CustomTypes"; }
            constexpr char const* dllName() const override { return "CustomTypes.dll"; }
            Il2CppClass* baseType() const override {
                ::i2c::functions::initialize();
                return ::i2c::functions::defaults->object_class;
            }
            std::vector<Il2CppClass*> const interfaces() const override { return {}; }
            constexpr Il2CppTypeEnum typeEnum() const override { return IL2CPP_TYPE_CLASS; }
            constexpr uint32_t typeFlags() const override { return 0; }
            static inline Il2CppClass* klass_ptr;
            Il2CppClass*& klass() const override { return klass_ptr; }
            constexpr size_t size() const override { return sizeof(___TargetType); }
            TypeRegistration* customBase() const override { return nullptr; }
            bool initialized() const override { return init; }
            void setInitialized() const override { init = true; }
            static inline bool init = false;
            static inline TypeRegistration* instance;
            static TypeRegistration* get() { return instance; }
        };
       ...
       private:
        struct ___MethodRegistrator_Invoke : ::custom_types::MethodRegistrator {
            constexpr char const* name() const override { return "Invoke"; }
            constexpr char const* csharpName() const override { return "Invoke"; }
            int flags() const override { return METHOD_ATTRIBUTE_STATIC; }
            MethodInfo const* virtualMethod() const override { return nullptr; }
            Il2CppType const* returnType() const override { return ::i2c::type_of<RI>(); }
            std::vector<Il2CppType const*> params() const override {
                ::i2c::functions::initialize();
                return {::i2c::functions::class_get_type(___TypeRegistration::klass_ptr), ::i2c::type_of<TArgsI>()...};
            }
            uint8_t params_size() const override { return sizeof...(TArgsI) + 1; }
            Il2CppMethodPointer methodPointer() const override { return reinterpret_cast<Il2CppMethodPointer>(&___TargetType::Invoke); }
            InvokerMethod invoker() const override { return &::custom_types::invoker_creator<decltype(&___TargetType::Invoke)>::invoke; }
        };

        struct ___MethodRegistrator_InvokeUnboxed : ::custom_types::MethodRegistrator {
            constexpr char const* name() const override { return "InvokeUnboxed"; }
            constexpr char const* csharpName() const override { return "InvokeUnboxed"; }
            int flags() const override { return METHOD_ATTRIBUTE_STATIC; }
            MethodInfo const* virtualMethod() const override { return nullptr; }
            Il2CppType const* returnType() const override {
                ::i2c::functions::initialize();
                return ::i2c::type_of<RI>();
            }
            std::vector<Il2CppType const*> params() const override {
                ::i2c::functions::initialize();
                return {::i2c::functions::class_get_type(___TypeRegistration::klass_ptr), (::i2c::type_of<TArgsI>())...};
            ...
            uint8_t params_size() const override { return sizeof...(TArgsI) + 1; }
            Il2CppMethodPointer methodPointer() const override { return reinterpret_cast<Il2CppMethodPointer>(&___TargetType::InvokeUnboxed); }
            InvokerMethod invoker() const override { return &::custom_types::invoker_creator<decltype(&___TargetType::InvokeUnboxed)>::invoke; }
        };
       ...
       private:
        ...
        struct ___MethodRegistrator_dtor<R (T::*)(TArgs...)> : ::custom_types::MethodRegistrator {
            constexpr char const* name() const override { return "dtor"; }
            constexpr char const* csharpName() const override { return "dtor"; }
            int flags() const override { return METHOD_ATTRIBUTE_VIRTUAL | METHOD_ATTRIBUTE_PUBLIC | METHOD_ATTRIBUTE_HIDE_BY_SIG; }
            MethodInfo const* virtualMethod() const override { return ::i2c::find_method({"System", "Object"}, {"Finalize", 0}); }
            Il2CppType const* returnType() const override {
                ::i2c::functions::initialize();
                return &::i2c::functions::defaults->void_class->byval_arg;
            }
            std::vector<Il2CppType const*> params() const override { return {}; }
            uint8_t params_size() const override { return 0; }
            ...
            InvokerMethod invoker() const override { return &::custom_types::invoker_creator<decltype(&___TargetType::dtor)>::invoke; }
        };
...
struct ::i2c::type_check::no_arg_class<custom_types::DelegateWrapperStatic<R, TArgs...>*> {
    static inline Il2CppClass* get() { return custom_types::DelegateWrapperStatic<R, TArgs...>::___TypeRegistration::klass_ptr; }
};
MARK_GEN_REF_T_PTR(custom_types::DelegateWrapperStatic);
...
namespace custom_types {
    ...
    template <class RI, class... TArgsI>
    RI __attribute__((noinline))
    DelegateWrapperStatic<RI, TArgsI...>::Invoke(DelegateWrapperStatic<RI, TArgsI...>* instance, make_boxed_t<TArgsI>... args) {
        if (!instance || !instance->wrappedFunc) {
            custom_types::logger.critical(
                "Attempting to invoke delegate on a null or destroyed instance: {}, class: {} ({})",
                fmt::ptr(instance),
                fmt::ptr(___TypeRegistration::klass_ptr),
    ...
    void DelegateWrapperStatic<RI, TArgsI...>::dtor() {
        custom_types::logger.debug(
            "Destroying delegate: {}, class: {} ({})", fmt::ptr(this), fmt::ptr(___TypeRegistration::klass_ptr), ___TypeRegistration::get()->name()
        );
    ...
    struct DelegateWrapperInstance : Il2CppObject {
       ...
       public:
        struct ___TypeRegistration : ::custom_types::TypeRegistration {
            ...
            std::vector<::custom_types::FieldRegistrator*> const getFields() const override { return {&___obj_FieldRegistrator}; }
            std::vector<::custom_types::StaticFieldRegistrator*> const getStaticFields() const override { return {}; }
            std::vector<::custom_types::MethodRegistrator*> const getMethods() const override {
                return {&___Invoke_MethodRegistrator, &___dtor_MethodRegistrator, &___InvokeUnboxed_MethodRegistrator};
            }
            ...
            static inline Il2CppClass* klass_ptr;
            Il2CppClass*& klass() const override { return klass_ptr; }
            constexpr std::size_t size() const override { return sizeof(___TargetType); }
            constexpr TypeRegistration* customBase() const override { return nullptr; }
            bool initialized() const override { return init; }
            void setInitialized() const override { init = true; }
            static inline bool init = false;
            static inline TypeRegistration* instance;
       ...
       private:
        struct ___FieldRegistrator_obj : ::custom_types::FieldRegistrator {
            constexpr char const* name() const override { return "obj"; }
            Il2CppType const* type() const override {
                ::i2c::functions::initialize();
                return ::i2c::type_of<TI>();
            }
            constexpr uint16_t fieldAttributes() const override { return FIELD_ATTRIBUTE_PUBLIC; }
            constexpr size_t size() const override { return sizeof(TI); }
            int32_t offset() const override { return offsetof(___TargetType, obj); }
        };
...
struct ::i2c::type_check::no_arg_class<custom_types::DelegateWrapperInstance<R, T, TArgs...>*> {
    static inline Il2CppClass* get() { return custom_types::DelegateWrapperInstance<R, T, TArgs...>::___TypeRegistration::klass_ptr; }
};
MARK_GEN_REF_T_PTR(custom_types::DelegateWrapperInstance);
...
namespace custom_types {
    ...
    template <class RI, class TI, class... TArgsI>
    RI __attribute__((noinline))
    DelegateWrapperInstance<RI, TI, TArgsI...>::Invoke(DelegateWrapperInstance<RI, TI, TArgsI...>* instance, make_boxed_t<TArgsI>... args) {
        if (!instance || !instance->wrappedFunc) {
            custom_types::logger.critical(
                "Attempting to invoke instance delegate that is null or has been destroyed! {}, class: {} ({})",
                fmt::ptr(instance),
                fmt::ptr(___TypeRegistration::klass_ptr),
                ___TypeRegistration::get()->name()
            );
    ...
    template <class RI, class TI, class... TArgsI>
    RI __attribute__((noinline))
    DelegateWrapperInstance<RI, TI, TArgsI...>::InvokeUnboxed(DelegateWrapperInstance<RI, TI, TArgsI...>* instance, TArgsI... args) {
        if (!instance || !instance->wrappedFunc) {
            custom_types::logger.critical(
                "Attempting to invoke instance delegate that is null or has been destroyed! {}, class: {} ({})",
                fmt::ptr(instance),
    ...
    T MakeDelegate(Il2CppClass const* delegateClass, DelegateWrapperStatic<R, TArgs...>* inst) {
        ::i2c::functions::initialize();
        ...
        auto* delegate = reinterpret_cast<Il2CppDelegate*>(::i2c::functions::object_new(delegateClass));
        // find the ctor method that takes object, intptr
        MethodInfo const* ctor_minfo = THROW_UNLESS(
            ::custom_types::logger,
            ::i2c::find_method(
                const_cast<Il2CppClass*>(delegateClass),
                {".ctor", {}, {i2c::type_of<Il2CppObject*>(), &::i2c::functions::defaults->int_class->this_arg}}
            )
        );

        // find the invoke method
        MethodInfo const* invoke_minfo;
        auto methodSpan = std::span(delegateClass->methods, delegateClass->method_count);
        for (auto const& method : methodSpan) {
            if (std::string_view(method->name) == "Invoke") {
        ...
        CRASH_UNLESS(::i2c::run_method<i2c::result<>>(delegate, ctor_minfo, inst, (void*) &method));
        ...
        custom_types::logger.debug(
            "Created delegate: {} ({}), for instance: {} with MethodInfo*: {}",
            fmt::ptr(delegate),
            fmt::ptr(delegateClass),
            fmt::ptr(inst),
            fmt::ptr(method)
        );
    ...
    T MakeDelegate(Il2CppClass const* delegateClass, DelegateWrapperInstance<R, I, TArgs...>* inst) {
        ::i2c::functions::initialize();
        custom_types::logger.debug(
            "Delegate instance dtor registrator: {}", fmt::ptr(DelegateWrapperInstance<R, I, TArgs...>::___dtor_MethodRegistrator.get())
        );
        ...
        custom_types::logger.debug(
            "Created instance delegate: {} ({}), for instance: {} with MethodInfo*: {}",
            fmt::ptr(delegate),
            fmt::ptr(delegateClass),
            fmt::ptr(inst),
            fmt::ptr(method)
    ...
    T MakeDelegate(Il2CppClass const* delegateClass, std::function<R(TArgs...)> const& f) {
        ::i2c::functions::initialize();
        ...
        custom_types::logger.debug(
            "Type registration for delegate being created (forcibly instantiated): {}",
            DelegateWrapperStatic<R, TArgs...>::__registration_instance_DelegateWrapperStatic.name()
        );
        auto* wrapperInstance = reinterpret_cast<DelegateWrapperStatic<R, TArgs...>*>(
            ::i2c::functions::object_new(DelegateWrapperStatic<R, TArgs...>::___TypeRegistration::klass_ptr)
        );
    ...
    T MakeDelegate(std::function<R(TArgs...)> const& f) {
        return MakeDelegate<T>(::i2c::class_of<T>(), f);
    }

    template <typename T = MulticastDelegate*, class R, class I, class... TArgs>
    // TODO: Requires that I has a classof
    T MakeDelegate(Il2CppClass const* delegateClass, I obj, std::function<R(I, TArgs...)> const& f) {
        ::i2c::functions::initialize();
        custom_types::logger.debug(
            "Type registration for delegate being created (forcibly instantiated): {}",
            DelegateWrapperInstance<R, I, TArgs...>::__registration_instance_DelegateWrapperInstance.name()
        );
        auto* wrapperInstance = reinterpret_cast<DelegateWrapperInstance<R, I, TArgs...>*>(
            ::i2c::functions::object_new(DelegateWrapperInstance<R, I, TArgs...>::___TypeRegistration::klass_ptr)
        );
        wrapperInstance->wrappedFunc = f;
    ...
    T MakeDelegate(I obj, std::function<R(I, TArgs...)> const& f) {
        return MakeDelegate<T>(::i2c::class_of<T>(), obj, f);
    }
}  // namespace custom_types
