...
namespace custom_types {
    ...
    void logAname(Il2CppAssemblyName const* name, std::string_view anameLabel) {
        if (!name) {
    ...
    void logFields(Il2CppClass const* klass) {
        if (!klass) {
    ...
    void logAsm(Il2CppAssembly const* assem) {
        if (!assem) {
    ...
    void logCodegen(Il2CppCodeGenModule const* m, std::string_view s) {
        if (!m) {
    ...
    void logImage(Il2CppImage const* img) {
        if (!img) {
    ...
    void logType(Il2CppType const* t, std::string_view s) {
    ...
    void logVtable(VirtualInvokeData const* invokeData) {
        if (!invokeData) {
    ...
    void logInterfaceOffset(Il2CppRuntimeInterfaceOffsetPair const* pair) {
        if (!pair) {
    ...
    void logParam(Il2CppType const* t, int index) {
        if (!t) {
    ...
    void logMethod(MethodInfo const* info) {
        if (!info) {
    ...
    void logAll(Il2CppClass const* klass) {
